        ...
        <>
            ...
            <div className="font-roboto m-20 relative overflow-x-auto border-2 rounded-md">
                <div className="bg-red flex justify-between items-center  gap-6 m-8">
                    {/* <div className="bg-[#41a8f4] text-white  border-2 border-b-4  border-black rounded-md p-2 px-3 hover:cursor-pointer   ">btn02</div> */}
                    {/* <div className="bg-[#41a8f4] text-white  border-2 border-b-4  border-black rounded-md p-2 px-3 hover:cursor-pointer   ">btn02</div> */}
                    <div className="flex gap-4">
                        <button className="bg-[#41a8f4] text-white  border-2 border-b-4  border-black rounded-md p-2 px-3 hover:cursor-pointer"> <strong>Filtrar</strong></button>
                    ...
                    <div className="bg-[#41a8f4] text-white  border-2 border-b-4  border-black rounded-md p-2 px-3 hover:cursor-pointer   ">
                ...
                <nav className="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4" aria-label="Table navigation">
                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">Showing <span className="font-semibold text-gray-900 dark:text-white">1-10</span> of <span className="font-semibold text-gray-900 ">1000</span></span>
